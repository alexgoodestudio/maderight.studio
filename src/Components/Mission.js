...
function Mission() {
  ...
  const text =
    "Made Right is a design-focused web development studio based in Columbia, South Carolina. Our goal is to bring together creativity and technology to create performant, lasting websites.";
