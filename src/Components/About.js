...
function About() {
  ...
  return (
    <section >
        <Nav/>
        <div className='className="about-section  py-5'>
        ...
        <div className="row align-items-center g-5">
          ...
          <div className="col-lg-12">
            <div className="content-wrapper ps-lg-4">
              ...
              <h3 className='bg-teal-950 text-white text-8xl eighties inline-block px-5 py-3 rounded-2xl mb-5'> Made Right</h3>
              <div ref={contentRef}>
                
                <p className="text-lg text-justify text-slate-700 mb-4 " style={{ lineHeight: '1.6' }}>
                  Made Right was started in April of 2025 in Columbia, South Carolina by Alex Goode. 
